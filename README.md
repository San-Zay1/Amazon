...
## Overview
This project involves working with an Amazon e-commerce dataset that contains information about various aspects of an online marketplace, including customers, products, orders, sellers, order items, category, inventory, payments, and shipping. The main tasks include organizing the dataset into a structured format, writing SQL queries (easy, medium, and advanced), and analyzing the data to find useful insights. The goal is to improve SQL skills and understand trends in e-commerce transactions.

The database consists of the following tables:

Customers: Stores customer details such as name, state, and address.

Products: Stores product details, including price, cost of goods sold (COGS), and category.

Category: Stores product category details.

Sellers: Stores seller details.

Orders: Stores order details, including customer and seller information, order status, and date.

Order Items: Stores information about items within an order, including quantity, price per unit, and total price.

Inventory: Tracks stock levels of products in warehouses, restock dates, and warehouse locations.

Payments: Stores payment transactions for orders, including payment mode, status, and date.

Shipping: Stores shipment details, including delivery status, shipping date, and return date.
